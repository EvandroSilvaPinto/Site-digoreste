...
<section class="wrapper">
	...
	<div class="content">
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel-default">
						...
						{!! Form::open(['method' => 'get', 'autocomplete' => 'on', 'route' => ['cms-reference']]) !!}           		    
							<div class="row">
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="form-row">
								   		<a href="{!!route('cms-reference-create')!!}" class="pull-right btn-quartenary">Novo <i class="fa fa-plus-circle" aria-hidden="true"></i></a>
							...
							<tbody>
								@foreach ($reference as $key => $value)
									<tr>
										...
										<td data-label="Ações">
										   	<a href="{!!route('cms-reference-delete',$value->reference_id)!!}" class="btn-primary"><i class="fa fa-times-circle" aria-hidden="true"></i></a>
											
										   	<a href="{!!route('cms-reference-show', $value->reference_id)!!}" class="btn-secondary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
										</td>
									</tr>
								@endforeach
							</tbody>
			...
			<div class="row">
				<div class="col-lg-12">
					{!!$reference->appends(Request::input())->render()!!}
				</div>
			</div>
		</div>
	</div>	
